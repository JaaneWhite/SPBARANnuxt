...
export const LazyAddressBlock = import('../..\\components\\AddressBlock.vue' /* webpackChunkName: "components_AddressBlock" */).then(c => c.default || c)
export const LazyExbBlock = import('../..\\components\\exbBlock.vue' /* webpackChunkName: "components_exbBlock" */).then(c => c.default || c)
...
export const LazyInventoryImgCard = import('../..\\components\\InventoryImgCard.vue' /* webpackChunkName: "components_InventoryImgCard" */).then(c => c.default || c)
export const LazyInventoryItem = import('../..\\components\\InventoryItem.vue' /* webpackChunkName: "components_InventoryItem" */).then(c => c.default || c)
...
export const LazyPhoneBlock = import('../..\\components\\PhoneBlock.vue' /* webpackChunkName: "components_PhoneBlock" */).then(c => c.default || c)
export const LazyTransportBlock = import('../..\\components\\TransportBlock.vue' /* webpackChunkName: "components_TransportBlock" */).then(c => c.default || c)
